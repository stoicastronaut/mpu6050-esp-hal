...
/// Type alias for MPU6050 register addresses
pub type MpuRegister = u8;
...
pub const MOT_THR: MpuRegister = 0x1F;
/// Motion Duration Detection Register
pub const MOT_DUR: MpuRegister = 0x20;
/// High Byte Register Gyro x orientation
pub const GYRO_REGX_H: MpuRegister = 0x43;
/// High Byte Register Gyro y orientation
pub const GYRO_REGY_H: MpuRegister = 0x45;
/// High Byte Register Gyro z orientation
pub const GYRO_REGZ_H: MpuRegister = 0x47;
/// High Byte Register Calc roll
pub const ACC_REGX_H: MpuRegister = 0x3b;
/// High Byte Register Calc pitch
pub const ACC_REGY_H: MpuRegister = 0x3d;
/// High Byte Register Calc yaw
pub const ACC_REGZ_H: MpuRegister = 0x3f;
/// High Byte Register Temperature
pub const TEMP_OUT_H: MpuRegister = 0x41;
/// Slave address of Mpu6050
pub const DEFAULT_SLAVE_ADDR: MpuRegister = 0x68;
/// Internal register to check slave addr
pub const WHO_AM_I: MpuRegister = 0x75;

/// Expected WHO_AM_I values for supported chips
pub const MPU6050_CHIP_ID: u8 = 0x68;
pub const MPU6500_CHIP_ID: u8 = 0x70;

/// List of valid chip IDs accepted by verify()
pub const VALID_CHIP_IDS: &[u8] = &[MPU6050_CHIP_ID, MPU6500_CHIP_ID];
...
impl CONFIG {
    /// Base Address
    pub const ADDR: MpuRegister = 0x1a;
...
impl GYRO_CONFIG {
    pub const ADDR: MpuRegister = 0x1b;
...
impl ACCEL_CONFIG {
    /// Base Address
    pub const ADDR: MpuRegister = 0x1c;
...
impl INT_PIN_CFG {
    /// Base Address
    pub const ADDR: MpuRegister = 0x37;
    /// INT pin logic level
...
impl INT_ENABLE {
    /// Base Address
    pub const ADDR: MpuRegister = 0x38;
...
impl INT_STATUS {
    /// Base Address
    pub const ADDR: MpuRegister = 0x3a;
    /// Free Fall Interrupt
...
impl MOT_DETECT_STATUS {
    /// Base Address
    pub const ADDR: MpuRegister = 0x61;
...
impl MOT_DETECT_CONTROL {
    /// Base Address
    pub const ADDR: MpuRegister = 0x69;
    /// Additional delay
...
impl PWR_MGMT_1 {
    /// Base Address
    pub const ADDR: MpuRegister = 0x6b;
    /// Device Reset bit
...
impl PWR_MGMT_2 {
    /// Base Address
    pub const ADDR: MpuRegister = 0x6c;
    /// Wake up frequency
